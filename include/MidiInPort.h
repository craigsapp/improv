...
#include "MidiEvent.h"
   ...
   #define MIDIINPORT  MidiInPort_osx
...
class MidiInPort : protected MIDIINPORT {
   public:
      ...
      void        extract(smf::MidiEvent& event) { MIDIINPORT::extract(event); }
...
// md5sum: 812f6a61d2d78bcc98355acb535b3e02 MidiInPort.h [20050403]
